...
#' @param feval User defined evaluation function. Returns list(metric='metric-name', value='metric-value') with given prediction and dtrain.
#'              Default evaluation metric is assigned by \code{params:objective}: weighted mse ([evalerror_reg()]) for regression, weighted mean error ([evalerror_bin()]) for logistic reg or binary classification.
