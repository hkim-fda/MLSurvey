#' Weighted Elastic Net (wEN) prediction models for complex survey data
#'
...
#'             \code{wlasso::wlasso()}, which is now officially available in \code{\link[svyVarSel]{wlasso}}.
#'
...
#'
#' @seealso [glmnet::glmnet()] for detailed information on return values.
#'
#'
#' @examples
#' # Do not run!
