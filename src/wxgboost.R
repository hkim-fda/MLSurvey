...
#'
#'@description This function allows as to fit Xgboost prediction (linear or logistic) models to complex survey data, considering sampling weights in the estimation process and selects the lambda that minimizes the error based on different replicating weights methods.
#'
...
wxgboost <- function(data = NULL, y =NULL, col.x = NULL,missing = NA, nthread=NULL,
  ...
  # Step 2: Fit CV to find the best iteration
