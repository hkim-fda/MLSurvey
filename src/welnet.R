...
#'            to select a lambda that minimizes the weighted mean error for a selected replicate weights method.
#'
...
#' @param cluster A character string indicating the name of the column with cluster identifiers. It could be \code{NULL} if the sampling design were plugged in the \code{design} argument.
...
#' @param train.prob A numeric value between 0 and 1 that sets the proportion of clusters (for the method \code{split}) or strata (for the method \code{extrapolation}) in training sets. Default is \code{train.prob = 0.7}.
