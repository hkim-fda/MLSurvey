...
#'
#'@description The function fits Elastic Net prediction (linear or logistic) models using sampling weights in the estimation process 
#'            and selects the lambda minimizing the error based on different replicating weights methods.
#'
