...
#'
#' @description
#'  A function estimating a confidence interval (CI) for wAUC, \code{wROC::wauc()}, by replicate weights from \code{survey::as.svrepdesign()}; \code{bootstrap} is Canty and Davison’s bootstrap, 
...
#' @param weights A character string indicating the name of sampling weights. \code{NULL} for either a unweighted case or the sampling design added in the \code{design} argument.
