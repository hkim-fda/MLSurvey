...
#' @param weights A character string indicating the name of sampling weights. \code{NULL} for either a unweighted case or the sampling design inserted in the \code{design} argument.
